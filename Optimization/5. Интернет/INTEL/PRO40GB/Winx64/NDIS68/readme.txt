PRO40GB Winx64 NDIS68 README
****************************

The driver package files in this folder can be used to install drivers
for Intel(R) Ethernet 700 Series devices on the following operating
systems:
...
[1] Only supported on:
    ...
    * 10Gbps Intel(R) Ethernet Controller X710 devices

    * 1Gbps Intel(R) Ethernet Controller I710 devices
